...
if __name__ == "__main__":
    ...
    for airport in airports:
        ...
        df.drop([u'gfs_press', u'gfs_rh', u'gfs_temp'], axis=1, inplace=True)
        ...
        for _ in range(2):
            ...
            for bin_size in bins:
                ...
                var_types_circular = ['linear', 'circular', 'linear']
        ...
        with open('/home/roz016/Dropbox/Data for Tree/Results/new_tree_cx10_lin_vs_cir/wind_spd_' + airport + '_winddir_only.csv', 'wb') as f:

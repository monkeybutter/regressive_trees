...
if __name__ == "__main__":
    ...
    for airport in airports:
        ...
        df.drop([u'metar_press', u'metar_rh', u'metar_temp', u'metar_wind_dir', u'date'], axis=1, inplace=True)
        ...
        with open('/home/roz016/Dropbox/Data for Tree/Results/new_tree_cx10_lin_vs_cir/wind_spd_' + airport + '_time.csv', 'wb') as f:

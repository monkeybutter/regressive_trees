...
if __name__ == "__main__":
    ...
    for airport in airports:
        ...
        df.drop([u'gfs_wind_dir', u'gfs_press', u'gfs_rh', u'gfs_temp'], axis=1, inplace=True)
        ...
        with open('/home/roz016/Dropbox/Data for Tree/Results/new_tree_cx10_lin_vs_cir/wind_spd_' + airport + '_wind_spd.csv', 'wb') as f:

...
for class_var in class_vars:
    ...
    for airport in airports:
        ...
        for i in range(cx_bin_number):
            ...
            with open('/home/roz016/Dropbox/Data for Tree/Results/cx5_lin_vs_cir_bin100_2/' + airport + '_' + class_var + '_bin100_cx' + str(i+1) + '_testdf.pick', 'w') as f:
            ...
            for gfs_type in gfs_types:
                ...
                with open('/home/roz016/Dropbox/Data for Tree/Results/cx5_lin_vs_cir_bin100_2/' + airport + '_' + class_var + '_bin100_cx' + '_validation.txt', 'a') as f:
                ...
                with open('/home/roz016/Dropbox/Data for Tree/Results/cx5_lin_vs_cir_bin100_2/' + airport + '_' + class_var + '_' + gfs_type["name"] + '_bin100_cx' + str(i+1) + '_tree.pick', 'w') as f:
                    pickle.dump(node, f)